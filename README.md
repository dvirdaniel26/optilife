# 🧬 OptiLife - מרחב בריאות אישי ומאמן AI

**קישור לפרויקט החי ב-Vercel:** [optilife-psi.vercel.app](https://optilife-psi.vercel.app)  
**קורס:** פיתוח מוצר מבוסס AI - פרויקט גמר  
**מגיש:** דביר דניאל

---

## 📝 סקירה כללית
**OptiLife** היא פלטפורמה רפואית-תזונתית מבוססת בינה מלאכותית (AI) המאפשרת למשתמשים להעלות צילומי בדיקות מעבדה (בדיקות דם), לנתח אותם באופן מיידי, לעקוב אחר מגמות המדדים שלהם לאורך זמן, ולקבל תוכניות תזונה וכושר מותאמות אישית.  
המערכת משלבת ממשק ייחודי דו-כיווני המאפשר ללקוחות לשתף את מדדיהם עם צוות מלווה (מאמנים ותזונאים) לצורך מעקב וקבלת הנחיות מותאמות בזמן אמת.

---

## 🎯 הבעיה שהפרויקט פותר (הכאב)
תוצאות בדיקות דם הן לרוב אוסף של מונחים רפואיים קשים להבנה וטווחי מספרים מבלבלים. אנשים רבים נאלצים להמתין שבועות לתור אצל רופא משפחה או תזונאי רק כדי להבין "מה אומרות התוצאות" וכיצד עליהם לפעול כדי לשפר אותן.  
**OptiLife פותרת את הכאב הזה בשלושה שלבים:**
...
* **בידול ה-WOW של OptiLife:**
  1. **OCR וניתוח תמונה רב-ממדי (Gemini AI):** סריקה ישירה של הבדיקה ללא הקלדה.
...
## 🔒 אבטחת מידע ופרטיות (Row Level Security - RLS)
בדיקות רפואיות הן מידע רגיש ביותר. המערכת מיושמת עם הגנות RLS מחמירות ב-Supabase:
...
3. **MFA (אימות דו-שלבי):** תשתית מובנית להפעלת אימות דו-שלבי מול אפליקציות Authenticator (לצרכי הגשה הוספנו כפתור מעקף מהיר לפיתוח בהגדרות החשבון).
...
## 🧠 תיאור תהליך הפיתוח (Vibe Coding / AI Collaboration)
הפרויקט פותח בשיתוף פעולה הדוק עם סוכן ה-AI **Antigravity**.  
