...
};on: 'תוצר פירוק חלבונים בכבד המופרש בשתן. מדד לתפקודי כליות.', high: 'יכול להעיד על התייבשות, תזונה עתירת חלבונים או בעיה כלייתית.', low: 'עלול להעיד על תזונה דלה בחלבון או מחלת כבד.', normal: '10-45 mg/dL' },
